...
Page({
  ...
  bindSave: function (e) {
    ...
    wx.request({
      url: app.globalData.domain + '/address/' + apiAddoRuPDATE,
      header: {
      ...
      data: {
        ...
        id: apiAddid,
        provinceId: 130000,//commonCityData.cityData[this.data.selProvinceIndex].id,
        cityId: 130200,
        districtId: 130227,
  ...
  onLoad: function (e) {
    ...
    if (id) {
      ...
      wx.showLoading();
      wx.request({
        url: app.globalData.domain + '/address/detail',
        header: {
          "Content-Type": "application/json"
        },
        method: "POST",
        ...
        success: function (res) {
          ...
          if (res.data.code == 0) {
            that.setData({
              ...
              selDistrict: res.data.data.area
            });
  ...
  deleteAddress: function (e) {
    ...
    wx.showModal({
      ...
      success: function (res) {
        if (res.confirm) {
          wx.request({
            url:  app.globalData.domain + '/address/delete',
            data: {
              token: wx.getStorageSync('token'),
              id: id
            },
